...
namespace Tuntenfisch.Grass
{
    public class GrassInteraction : MonoBehaviour
    {
        ...
        private const float c_debugTextureSize = 256;
        ...
        private void Start()
        {
            ...
            m_copyDepthMaterial = new Material(Shader.Find("Tuntenfisch Commons/Misc/Copy Depth"));
        ...
        private void OnGUI()
        {
            ...
            Rect interactionRect = new Rect(0.0f, 0.0f, c_debugTextureSize, c_debugTextureSize);
            Rect interactionDepthRect = new Rect(c_debugTextureSize, 0.0f, c_debugTextureSize, c_debugTextureSize);
